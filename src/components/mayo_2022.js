...
const Mayo = ({guarda, stylesMonths, dayToday, monthToday}) => {
  return ( 
    <Cal monthActive={stylesMonths}>
      <HeaderCal>
        <TitleMonth> Mayo 2023 </TitleMonth> 
      </HeaderCal>
      <TableDays>
        <tbody>
          <tr>
        ...
        <Curr> 
          {
            ...
            <tbody> 
              ...
              <tr><DaysNumber style={{border: '2px solid red', backgroundColor: 'pink'}}>21</DaysNumber><DaysNumber style={{border: '2px solid red', backgroundColor: 'pink'}}>22</DaysNumber><DaysNumber style={{backgroundColor: 'yellowgreen'}}>23</DaysNumber><DaysNumber style={{backgroundColor: 'yellowgreen'}}>24</DaysNumber><DaysNumber style={{backgroundColor: 'yellow'}}>25</DaysNumber><DaysNumber style={{backgroundColor: 'yellow'}}>26</DaysNumber><DaysNumber style={{backgroundColor: 'pink'}}>27</DaysNumber></tr> 
              <tr><DaysNumber style={{border: '2px solid red', backgroundColor: 'pink'}}>28</DaysNumber><DaysNumber style={{backgroundColor: 'yellowgreen'}}>29</DaysNumber><DaysNumber style={{backgroundColor: 'yellowgreen'}}>30</DaysNumber><DaysNumber style={{backgroundColor: 'yellow'}}>31</DaysNumber><DaysNumber></DaysNumber><DaysNumber></DaysNumber><DaysNumber></DaysNumber></tr>
            </tbody>
          }
